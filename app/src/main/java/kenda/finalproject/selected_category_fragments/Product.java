package kenda.finalproject.selected_category_fragments;
...
import kenda.finalproject.Data_Center.Customer;
import kenda.finalproject.Data_Center.Item;
...
public class Product extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productPriceView.setText(productInfoBundle.getInt("item_price") + " Shekel");
